...
public class EMFProfileDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "org.modelversioning.emfprofile.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public EMFProfileDiagramEditorPlugin() {
	}
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories.add(new EMFProfileItemProviderAdapterFactory());
	...
	public EMFProfileDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new EMFProfileDocumentProvider();
		}
	...
	public void setLinkConstraints(
			EMFProfileBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, EMFProfileDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, EMFProfileDiagramEditorPlugin.ID,

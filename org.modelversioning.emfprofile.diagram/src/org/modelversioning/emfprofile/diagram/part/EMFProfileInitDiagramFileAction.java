 ...
 * @generated
 */
public class EMFProfileInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = EMFProfileDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new EMFProfileNewDiagramFileWizard(resource.getURI(),
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProfileEditPart.MODEL_ID));
		EMFProfileDiagramEditorUtil.runWizard(getShell(), wizard,

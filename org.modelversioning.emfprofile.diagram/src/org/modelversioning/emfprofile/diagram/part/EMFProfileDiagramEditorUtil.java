 ...
 * @generated
 */
public class EMFProfileDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.EMFProfileDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.EMFProfileDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = EMFProfileDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI,
		...
		progressMonitor.beginTask(
				Messages.EMFProfileDiagramEditorUtil_CreateDiagramProgressTask,
				3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.EMFProfileDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					...
					diagramResource
							.save(org.modelversioning.emfprofile.diagram.part.EMFProfileDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	...
	private static Profile createInitialModel() {
		return EMFProfileFactory.eINSTANCE.createProfile();
	}

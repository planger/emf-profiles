 ...
 * @generated
 */
public class EMFProfileShortcutsDecoratorProvider extends AbstractProvider
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ProfileEditPart.MODEL_ID.equals(EMFProfileVisualIDRegistry
						.getModelID(view));
	}
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = EMFProfileDiagramEditorPlugin.getInstance()

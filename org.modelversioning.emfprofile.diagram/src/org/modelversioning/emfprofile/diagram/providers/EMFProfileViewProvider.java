 ...
 * @generated
 */
public class EMFProfileViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ProfileEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EMFProfileVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EMFProfileVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!EMFProfileElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != EMFProfileVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!ProfileEditPart.MODEL_ID.equals(EMFProfileVisualIDRegistry
		...
		return StereotypeEditPart.VISUAL_ID == visualID
				|| EClassEditPart.VISUAL_ID == visualID
				|| EPackageEditPart.VISUAL_ID == visualID
				|| EEnumEditPart.VISUAL_ID == visualID
				|| EDataTypeEditPart.VISUAL_ID == visualID
				|| EAttributeEditPart.VISUAL_ID == visualID
				|| EAttribute2EditPart.VISUAL_ID == visualID
				|| EOperationEditPart.VISUAL_ID == visualID
				|| EClass2EditPart.VISUAL_ID == visualID
				|| EEnumLiteralEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EMFProfileVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EMFProfileVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = EMFProfileVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case StereotypeEditPart.VISUAL_ID:
		...
		case EClassEditPart.VISUAL_ID:
			return createEClass_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EPackageEditPart.VISUAL_ID:
			return createEPackage_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case EEnumEditPart.VISUAL_ID:
			return createEEnum_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case EDataTypeEditPart.VISUAL_ID:
			return createEDataType_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case EAttributeEditPart.VISUAL_ID:
			return createEAttribute_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case EAttribute2EditPart.VISUAL_ID:
			return createEAttribute_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case EOperationEditPart.VISUAL_ID:
			return createEOperation_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case EClass2EditPart.VISUAL_ID:
			return createEClass_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EEnumLiteralEditPart.VISUAL_ID:
			return createEEnumLiteral_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case EReferenceEditPart.VISUAL_ID:
			return createEReference_4003(getSemanticElement(semanticAdapter),
	...
	public Node createStereotype_2001(EObject domainElement,
		...
		node.setType(EMFProfileVisualIDRegistry
				.getType(StereotypeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createEClass_2002(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EMFProfileVisualIDRegistry
				.getType(EClassEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EClassAttributesEditPart.VISUAL_ID), true,
				false, true, true);
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EClassOperationsEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEPackage_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EMFProfileVisualIDRegistry
				.getType(EPackageEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EPackageContentsEditPart.VISUAL_ID), true,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEEnum_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EMFProfileVisualIDRegistry
				.getType(EEnumEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5005 = createLabel(node,
				EMFProfileVisualIDRegistry.getType(EEnumNameEditPart.VISUAL_ID));
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EEnumLiteralsEditPart.VISUAL_ID), true, false,
				true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEDataType_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EMFProfileVisualIDRegistry
				.getType(EDataTypeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5007 = createLabel(node,
				EMFProfileVisualIDRegistry
						.getType(EDataTypeInstanceClassNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEAttribute_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
	 ...
	 * @generated
	 */
	public Node createEAttribute_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
		node.setType(EMFProfileVisualIDRegistry
				.getType(EAttribute2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEOperation_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	 ...
	 * @generated
	 */
	public Node createEClass_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EClassAttributes2EditPart.VISUAL_ID), true,
				false, true, true);
		createCompartment(node,
				EMFProfileVisualIDRegistry
						.getType(EClassOperations2EditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEEnumLiteral_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	 ...
	 * @generated
	 */
	public Edge createEClassESuperTypes_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(EMFProfileVisualIDRegistry
				.getType(EClassESuperTypesEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createEReference_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(EMFProfileVisualIDRegistry
				.getType(EReferenceEditPart.VISUAL_ID));
		...
		Node label6002 = createLabel(
				edge,
				EMFProfileVisualIDRegistry
						.getType(EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ProfileEditPart.MODEL_ID.equals(EMFProfileVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ProfileEditPart.MODEL_ID); //$NON-NLS-1$

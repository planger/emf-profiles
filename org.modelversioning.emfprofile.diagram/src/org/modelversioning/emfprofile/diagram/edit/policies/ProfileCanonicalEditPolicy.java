 ...
 * @generated
 */
public class ProfileCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(EcorePackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getProfile_1000SemanticChildren(viewObject);
	...
	protected boolean isOrphaned(Collection<EObject> semanticChildren,
		...
		if (view.getEAnnotation("Shortcut") != null) { //$NON-NLS-1$
			return EMFProfileDiagramUpdater.isShortcutOrphaned(view);
		}
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = EMFProfileVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	protected void refreshSemantic() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getProfile_1000SemanticChildren((View) getHost().getModel());
		...
		for (View v : getViewChildren()) {
			...
			if (v.getEAnnotation("Shortcut") != null && EMFProfileDiagramUpdater.isShortcutOrphaned(v)) { //$NON-NLS-1$
				orphaned.add(v);
			}
		}
		...
		for (Iterator<EMFProfileNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			EMFProfileNodeDescriptor next = descriptorsIterator.next();
			String hint = EMFProfileVisualIDRegistry
		...
		for (EMFProfileNodeDescriptor next : childDescriptors) {
			String hint = EMFProfileVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<EMFProfileLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = EMFProfileVisualIDRegistry
			...
			for (Iterator<EMFProfileLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				EMFProfileLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<EMFProfileLinkDescriptor> collectAllLinks(View view,
		...
		case ProfileEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getProfile_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case EClassEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEClass_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EPackageEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEPackage_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EEnumEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEEnum_2004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EDataTypeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEDataType_2005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EClass2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEClass_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EReferenceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(EMFProfileDiagramUpdater
						.getEReference_4003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<EMFProfileLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (EMFProfileLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					EMFProfileVisualIDRegistry.getType(nextLinkDescriptor

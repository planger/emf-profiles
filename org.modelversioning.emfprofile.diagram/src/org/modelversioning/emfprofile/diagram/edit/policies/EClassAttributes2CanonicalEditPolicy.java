...
public class EClassAttributes2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEClassAttributes_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EAttribute2EditPart.VISUAL_ID == EMFProfileVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEClassAttributes_7006SemanticChildren((View) getHost()
						.getModel());

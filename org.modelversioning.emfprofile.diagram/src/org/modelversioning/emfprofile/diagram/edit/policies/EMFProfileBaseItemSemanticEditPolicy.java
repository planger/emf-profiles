 ...
 * @generated
 */
public class EMFProfileBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected EMFProfileBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						EMFProfileVisualIDRegistry.getVisualID((View) view));
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(EMFProfileBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(EMFProfileBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(EMFProfileBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(EMFProfileBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = EMFProfileElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = EMFProfileDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			EMFProfileDiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateEClassESuperTypes_4002(EClass source,
				EClass target) {
			if (source != null) {
			...
			return canExistEClassESuperTypes_4002(source, target);
		}
		 ...
		 * @generated
		 */
		public boolean canExistEClassESuperTypes_4002(EClass source,
				EClass target) {
			try {
				if (target == null) {
					return true;
					...
					Object targetVal = EMFProfileOCLFactory.getExpression(1,
							EcorePackage.eINSTANCE.getEClass(), env).evaluate(
							target,
			...
			try {
				if (target == null) {
					...
					Map<String, EClassifier> env = Collections
							.<String, EClassifier> singletonMap(
									"oppositeEnd", EcorePackage.eINSTANCE.getEClass()); //$NON-NLS-1$
					Object targetVal = EMFProfileOCLFactory.getExpression(2,

...
public class EClassOperations2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEClassOperations_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EOperationEditPart.VISUAL_ID == EMFProfileVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEClassOperations_7007SemanticChildren((View) getHost()
						.getModel());

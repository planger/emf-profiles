...
public class EPackageContentsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEPackageContents_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EClass2EditPart.VISUAL_ID == EMFProfileVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEPackageContents_7002SemanticChildren((View) getHost()
						.getModel());

 ...
 * @generated
 */
public class EPackageItemSemanticEditPolicy extends
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case EClass2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (EMFProfileVisualIDRegistry
									.getVisualID(incomingLink) == EClassESuperTypesEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(),
										null, incomingLink.getTarget()
												.getElement(), false);
							...
							if (EMFProfileVisualIDRegistry
									.getVisualID(incomingLink) == EReferenceEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (EMFProfileVisualIDRegistry
									.getVisualID(outgoingLink) == EClassESuperTypesEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
							...
							if (EMFProfileVisualIDRegistry
									.getVisualID(outgoingLink) == EReferenceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(

...
public class EEnumLiteralsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEEnumLiterals_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return EEnumLiteralEditPart.VISUAL_ID == EMFProfileVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EMFProfileNodeDescriptor> childDescriptors = EMFProfileDiagramUpdater
				.getEEnumLiterals_7003SemanticChildren((View) getHost()
						.getModel());

 ...
 * @generated
 */
public class StereotypeBaseCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StereotypeBaseCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStereotypeBase_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getBase().add(getTarget());
		}

 ...
 * @generated
 */
public class StereotypeBaseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StereotypeBaseReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof Stereotype) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof EClass && newEnd instanceof Stereotype)) {
			return false;
		}
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStereotypeBase_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStereotypeBase_4001(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getBase().remove(getOldTarget());
		getNewSource().getBase().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getBase().remove(getOldTarget());
		getOldSource().getBase().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
	...
	protected Stereotype getOldSource() {
		return (Stereotype) referenceOwner;
	}

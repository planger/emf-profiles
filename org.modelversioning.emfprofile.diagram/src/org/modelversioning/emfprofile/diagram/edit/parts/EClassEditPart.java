...
import org.modelversioning.emfprofile.diagram.edit.policies.EClassItemSemanticEditPolicy;
...
public class EClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EClassNameEditPart) {
			((EClassNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.modelversioning.emfprofile.diagram.edit.parts.EClassEditPart) {
			types.add(EMFProfileElementTypes.EClassESuperTypes_4002);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EMFProfileElementTypes.EAttribute_3004) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry
						.getType(EClassAttributesEditPart.VISUAL_ID));
			}
			if (type == EMFProfileElementTypes.EOperation_3005) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry
						.getType(EClassOperationsEditPart.VISUAL_ID));
			}
		}
	...
	public class ClassFigure extends GradientRectangleFigure {
		...
		private void createContents() {
			...
			//classDecoLabel0.setAlignment(PositionConstants.CENTER);

...
import org.modelversioning.emfprofile.diagram.edit.policies.EEnumItemSemanticEditPolicy;
...
public class EEnumEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EEnumItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EEnumNameEditPart) {
			((EEnumNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EMFProfileElementTypes.EEnumLiteral_3003) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry
						.getType(EEnumLiteralsEditPart.VISUAL_ID));
			}
		}
	...
	public class EnumerationFigure extends GradientRectangleFigure {
		...
		private void createContents() {
			...
			enumerationFixedNameLabel0.setAlignment(PositionConstants.CENTER);

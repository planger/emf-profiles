...
public class EMFProfileOCLFactory {
	 ...
	 * @generated
	 */
	private final EMFProfileAbstractExpression[] expressions;

	/**
	 * @generated
	 */
	protected EMFProfileOCLFactory() {
		this.expressions = new EMFProfileAbstractExpression[3];
	}

	/**
	 * @generated
	 */
	public static EMFProfileAbstractExpression getExpression(int index,
			EClassifier context, Map<String, EClassifier> environment) {
		EMFProfileOCLFactory cached = EMFProfileDiagramEditorPlugin
				.getInstance().getEMFProfileOCLFactory();
		if (cached == null) {
	 ...
	 * @generated
	 */
	public static EMFProfileAbstractExpression getExpression(String body,
			EClassifier context, Map<String, EClassifier> environment) {
	 ...
	 * @generated
	 */
	private static class Expression extends EMFProfileAbstractExpression {

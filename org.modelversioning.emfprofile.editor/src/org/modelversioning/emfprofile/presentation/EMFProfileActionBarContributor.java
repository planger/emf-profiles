...
public class EMFProfileActionBarContributor extends
	...
	protected IAction showPropertiesViewAction = new Action(
			EMFProfileEditorPlugin.INSTANCE
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		// toolBarManager.add(extendedLoadResourceAction);
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				EMFProfileEditorPlugin.INSTANCE
						.getString("_UI_EMFProfileEditor_menu"),
				"org.modelversioning.emfprofileMenuID");
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		...
		// menuManager.insertAfter("ui-actions", loadResourceAction);
